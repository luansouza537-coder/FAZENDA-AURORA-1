...
const [currentScreen, setCurrentScreen] = useState<'splash' | 'title' | 'game'>('splash');
  ...
  const advanceDay = (event: React.MouseEvent) => {
    try {
      ...
      if (isWeeklyBillDay) {
        const LONG_BASE_PRICES: Record<string, number> = { milk: 5, egg: 4, wool: 12, cheese: 20, queijoCoalho: 28, queijoMucarela: 55, queijoBrie: 90, butter: 45, yogurt: 35, goat_milk: 14, buffalo_milk: 28, buffalo_mozzarella: 120, duck_egg: 18, quail_egg: 22, goose_egg: 50, feather: 15, peacock_feather: 80, alpaca_wool: 65, angora_wool: 90, llama_wool: 45, muco: 35, mel_envasado: 80, seda_bruta: 100, boi: 300, porco: 180 };
        contracts.forEach(c => {
