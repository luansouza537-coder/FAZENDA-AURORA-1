...
const [currentScreen, setCurrentScreen] = useState<'splash' | 'title' | 'game'>('splash');
  ...
  const LONG_CONTRACT_CATALOG = [
    ...
    { catalogId: 'lc_g41', client: 'Rotisseria Bella Massa', product: 'massa_fresca' as const, description: 'Rotisseria de massas frescas feitas à vista do cliente. A massa com ovo de ganso tem cor e liga incomparáveis — a casa quer fornecimento fixo para os domingos.', baseMarket: 78, pricePerUnit: 101, weeklyGoal: 2, durationDays: 60, minLevel: 6, completionBonus: 240, completionXP: 35 },
