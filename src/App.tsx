...
const [currentScreen, setCurrentScreen] = useState<'splash' | 'title' | 'game'>('splash');
  ...
  const LONG_CONTRACT_CATALOG = [
    ...
    { catalogId: 'lc_g46', client: 'Cooperativa Leite do Vale', product: 'milk' as const, description: 'Cooperativa grande que abastece escolas e mercados da região. Pagam um pouco menos por litro que a concorrência — mas compram volume alto, toda semana, sem falta.', baseMarket: 8, pricePerUnit: 9, weeklyGoal: 18, durationDays: 90, minLevel: 3, completionBonus: 195, completionXP: 25 },
    { catalogId: 'lc_g47', client: 'Rede Café Aurora', product: 'egg' as const, description: 'Rede de cafeterias em expansão que consome bandejas de ovos por dia. Contrato de volume: meta alta, pagamento certo e a chance de crescer junto com a rede.', baseMarket: 4, pricePerUnit: 5, weeklyGoal: 25, durationDays: 90, minLevel: 3, completionBonus: 150, completionXP: 25 },
    { catalogId: 'lc_g48', client: 'Tecelagem Fio do Campo', product: 'wool' as const, description: 'Tecelagem industrial que produz cobertores para lojas de departamento. Precisam de lã crua em quantidade — menos romance, mais escala.', baseMarket: 15, pricePerUnit: 19, weeklyGoal: 10, durationDays: 90, minLevel: 4, completionBonus: 230, completionXP: 25 },
    { catalogId: 'lc_g49', client: 'Distribuidora Queijo & Prosa', product: 'cheese' as const, description: 'Distribuidora que leva queijo simples para padarias de toda a região. Giro alto e meta puxada — perfeito para quem tem várias vacas no pasto.', baseMarket: 30, pricePerUnit: 38, weeklyGoal: 8, durationDays: 90, minLevel: 4, completionBonus: 365, completionXP: 25 },
    { catalogId: 'lc_g50', client: 'Peixaria Água Doce', product: 'peixe' as const, description: 'Peixaria de mercado municipal com balcão disputado desde cedo. Querem tilápia em volume para a banca do sábado — meta alta, preço justo.', baseMarket: 45, pricePerUnit: 58, weeklyGoal: 10, durationDays: 90, minLevel: 8, completionBonus: 695, completionXP: 60 },
  ] as const;
