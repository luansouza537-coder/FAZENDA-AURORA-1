...
const [currentScreen, setCurrentScreen] = useState<'splash' | 'title' | 'game'>('splash');
  ...
  const LONG_CONTRACT_CATALOG = [
    ...
    { catalogId: 'lc_np2', client: 'Restaurante do Porto', product: 'peixe' as const, description: 'Restaurante à beira do rio famoso pela tilápia fresca. O chef faz questão de peixe do dia, criado em água limpa. Entregas semanais pontuais mantêm o cardápio — e a reputação de vocês dois.', baseMarket: 45, pricePerUnit: 55, weeklyGoal: 5, durationDays: 60, minLevel: 6, completionBonus: 280, completionXP: 35 },
    ...
    { catalogId: 'lc_np4', client: 'Boutique de Queijos Alvorada', product: 'queijo_minas_jersey' as const, description: 'Boutique especializada em queijos de leite Jersey — mais gordo, mais sabor. Clientela fiel que paga caro pelo frescal autêntico. Um contrato de prestígio para queijeiros de elite.', baseMarket: 95, pricePerUnit: 115, weeklyGoal: 2, durationDays: 60, minLevel: 8, completionBonus: 420, completionXP: 45 },
    ...
    { catalogId: 'lc_g01', client: 'Empório Jersey & Cia', product: 'leite_jersey' as const, description: 'Casa de produtos finos que descobriu o leite Jersey e não quer outro: mais gordura, mais sabor, mais clientes voltando. Querem fornecimento semanal fixo para a linha de cafés especiais e cremes da casa.', baseMarket: 14, pricePerUnit: 18, weeklyGoal: 6, durationDays: 60, minLevel: 6, completionBonus: 130, completionXP: 35 },
    { catalogId: 'lc_g02', client: 'Confeitaria Flor de Lis', product: 'manteiga_jersey' as const, description: 'Confeitaria de bairro famosa pelos croissants folhados. A chef jura que a manteiga Jersey é o segredo da massa — e paga a mais para não deixar o forno esperando.', baseMarket: 60, pricePerUnit: 78, weeklyGoal: 3, durationDays: 60, minLevel: 6, completionBonus: 280, completionXP: 35 },
    { catalogId: 'lc_g03', client: 'Doceria Vovó Mercedes', product: 'doce_leite_jersey' as const, description: 'Doceria de tradição familiar, três gerações atrás do mesmo tacho de cobre. O doce de leite Jersey virou o carro-chefe das caixas de presente — produção pequena, exigência enorme.', baseMarket: 120, pricePerUnit: 156, weeklyGoal: 2, durationDays: 60, minLevel: 7, completionBonus: 375, completionXP: 35 },
    { catalogId: 'lc_g04', client: 'Queijaria Vila Holanda', product: 'gouda_jersey' as const, description: 'Casa de queijos especiais que monta tábuas para eventos e vinícolas. O Gouda de leite Jersey maturado é a estrela do catálogo — eles sabem que leva dias para ficar pronto e pagam pela paciência.', baseMarket: 200, pricePerUnit: 260, weeklyGoal: 1, durationDays: 120, minLevel: 8, completionBonus: 310, completionXP: 60 },
