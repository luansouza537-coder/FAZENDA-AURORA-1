export const WORKER_TYPES = [
  { role: 'tratador'             as const, name: 'Tratador',           emoji: '🧑‍🌾', dailyCost: 80,  desc: 'Alimenta todos os animais diariamente. Essencial para rebanhos grandes.',                                                       minLevel: 2 },
  { role: 'composteiro'          as const, name: 'Composteiro',        emoji: '🌱',  dailyCost: 65,  desc: 'Supervisiona a compostagem e gera +1 húmus bônus a cada 3 dias.',                                                              minLevel: 3 },
  { role: 'tosquiador'           as const, name: 'Tosquiador',         emoji: '✂️',  dailyCost: 95,  desc: 'Coleta lã de ovelhas, lhamas, coelhos e cabras angorá prontos. Tem chance de lã premium (+10%).',                                                minLevel: 3 },
  { role: 'ordenhador'           as const, name: 'Ordenhador',         emoji: '🥛',  dailyCost: 120, desc: 'Ordena vacas, cabras, búfalos e ovelhas leiteiras automaticamente ao fim do dia. Também coleta lã de alpacas prontas.',       minLevel: 4 },
  { role: 'avicultor'            as const, name: 'Avicultor',          emoji: '🥚',  dailyCost: 95,  desc: 'Coleta ovos de galinhas (diário), patos (diário) e gansos (a cada 3 dias) automaticamente. Cuida do peru em engorda.',  minLevel: 5 },
