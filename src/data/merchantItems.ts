export const MERCHANT_SPECIAL_ITEMS = [
  { id: 'racao_granel',         label: '🚚 Carga de Ração a Granel',     desc: 'Compra por atacado: escolha um tipo de ração e receba +30 unidades', price: 90,  effect: 'bulk_feed' },
  ...
  { id: 'visita_veterinario',   label: '🚑 Visita do Veterinário',       desc: 'O veterinário trata todos os doentes (60💰 por animal). Curados descansam 1 dia sem produzir', price: 60, effect: 'vet_visit' },
  { id: 'consultoria_agro',     label: '👨‍🌾 Consultoria Agronômica',     desc: 'Um agrônomo otimiza o manejo da fazenda: +15% produção por 7 dias', price: 220, effect: 'production_boost_7days' },
  { id: 'vacinacao',            label: '💉 Campanha de Vacinação',       desc: 'Rebanho vacinado por 30 dias: sem epidemias e animais adoecem menos', price: 250, effect: 'vaccination_30days' },
  ...
  { id: 'reforco_telhado',      label: '🪵 Reforço de Telhado',          desc: 'Estruturas reforçadas: tempestades causam 60% menos impacto (permanente)', price: 180, effect: 'roof_reinforcement', oneTime: true },
  { id: 'caminhao_pipa',        label: '🚛 Caminhão-Pipa',               desc: 'Água garantida por 14 dias: secas não afetam a fazenda',          price: 120, effect: 'water_truck_14days' },
