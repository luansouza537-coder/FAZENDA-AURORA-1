export const MERCHANT_SPECIAL_ITEMS = [
  ...
  { id: 'vacinacao',            label: '💉 Campanha de Vacinação',       desc: 'Rebanho vacinado por 30 dias: sem epidemias e animais adoecem menos', price: 250, effect: 'vaccination_30days' , group: 'saude' as const },
