...
const CRAFT_COSTS: Record<string, { energy: number; water: number }> = {
  ...
  butter:           { energy: 1, water: 1 },
  yogurt:           { energy: 1, water: 1 },
  buffalo_mozzarella:{ energy: 1, water: 2 },
  queijo_cabra:     { energy: 1, water: 1 },
  ...
  colete_couro:     { energy: 2, water: 2 },
  bolsa_exotica:    { energy: 2, water: 2 },
  cheese:           { energy: 1, water: 1 },
  queijoCoalho:     { energy: 2, water: 1 },
  queijoMucarela:   { energy: 2, water: 1 },
  queijoBrie:       { energy: 2, water: 1 },
  queijo_parmesao:  { energy: 2, water: 1 },
  queijo_serra:     { energy: 2, water: 1 },
  kit_gourmet:      { energy: 2, water: 1 },
  scarf:            { energy: 2, water: 1 },
  ...
  fio_lhama:        { energy: 1, water: 1 },
  cachecol_lhama:   { energy: 1, water: 1 },
  gorro_lhama:      { energy: 1, water: 1 },
  luvas_lhama:      { energy: 1, water: 1 },
  poncho_lhama:     { energy: 2, water: 2 },
  manta_lhama:      { energy: 2, water: 2 },
  iogurte_bufala:   { energy: 1, water: 1 },
  manteiga_bufala:  { energy: 1, water: 1 },
  doce_leite_bufala:{ energy: 2, water: 0 },
  burrata:          { energy: 1, water: 2 },
  massa_fresca:     { energy: 1, water: 1 },
  crepe_rustico:    { energy: 1, water: 1 },
