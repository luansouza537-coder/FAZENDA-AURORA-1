  ...
  },
  {
    ...
    content: (
      <ul className="text-stone-700 space-y-2 text-xs sm:text-sm list-disc pl-4">
        ...
        <li><strong className="text-[#b45309]">🌍 Exportação Internacional:</strong> Contratos de exportação (a partir do nível 1) pagam bem acima do preço de mercado — o caminho premium para vender sua produção.</li>
