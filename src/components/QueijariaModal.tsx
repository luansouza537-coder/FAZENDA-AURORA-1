...
export interface CraftActions {
  ...
  craftManteigaJersey: (e?: React.MouseEvent) => void;
  craftQueijoMinasJersey: (e?: React.MouseEvent) => void;
  craftDoceLeiteJersey: (e?: React.MouseEvent) => void;
  craftGoudaJersey: (e?: React.MouseEvent) => void;
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {[
                      ...
                      { label: 'Muçarela Búfala', emoji: '🧀', req: `🥛 3 L.Búfala (${inventory.buffalo_milk ?? 0}/3) • ⌛ 10d • Nv4`, canCraft: farmLevel >= 4 && (inventory.buffalo_milk ?? 0) >= 3 && queijosEmMaturacao.length < maxPrateleiras, reqLevel: 4, onClick: (e: React.MouseEvent) => c.craftBuffaloMozzarella(e) },
            ...
            {atelieTab === 'cozinha' && (
              <div className="space-y-2">
                ...
                {[
                  ...
                  { label: 'Ovo Defumado', emoji: '🥚', req: `🪿 1 Ov.Ganso (${inventory.goose_egg ?? 0}/1) • Nv13`, canCraft: farmLevel >= 13 && (inventory.goose_egg ?? 0) >= 1, reqLevel: 13, onClick: (e: React.MouseEvent) => c.craftOvoDefumado(e) },
                  { label: 'Conserva de Codorna', emoji: '🥚', req: `🐦 6 Ov.Codorna (${inventory.quail_egg ?? 0}/6) • Nv11`, canCraft: farmLevel >= 11 && (inventory.quail_egg ?? 0) >= 6, reqLevel: 11, onClick: (e: React.MouseEvent) => c.craftConservaCodorna(e) },
                  ...
                  { label: 'Manteiga Jersey', emoji: '🧈', req: `🥛 2 L.Jersey (${(inventory as any).leite_jersey ?? 0}/2) • Nv15`, canCraft: farmLevel >= 15 && ((inventory as any).leite_jersey ?? 0) >= 2, reqLevel: 15, onClick: (e: React.MouseEvent) => c.craftManteigaJersey(e) },
                  { label: 'Queijo Minas Jersey', emoji: '🧀', req: `🥛 3 L.Jersey (${(inventory as any).leite_jersey ?? 0}/3) + 🧂 1 Sal (${(inventory as any).sal ?? 0}/1) • Nv15`, canCraft: farmLevel >= 15 && ((inventory as any).leite_jersey ?? 0) >= 3 && ((inventory as any).sal ?? 0) >= 1, reqLevel: 15, onClick: (e: React.MouseEvent) => c.craftQueijoMinasJersey(e) },
                  { label: 'Doce de Leite Jersey', emoji: '🍮', req: `🥛 2 L.Jersey (${(inventory as any).leite_jersey ?? 0}/2) + 🍯 1 Mel (${(inventory as any).mel ?? 0}/1) • Nv15`, canCraft: farmLevel >= 15 && ((inventory as any).leite_jersey ?? 0) >= 2 && ((inventory as any).mel ?? 0) >= 1, reqLevel: 15, onClick: (e: React.MouseEvent) => c.craftDoceLeiteJersey(e) },
                  { label: 'Gouda Jersey (matura 8d)', emoji: '🧀', req: `🥛 4 L.Jersey (${(inventory as any).leite_jersey ?? 0}/4) + 🧂 1 Sal (${(inventory as any).sal ?? 0}/1) • Nv15`, canCraft: farmLevel >= 15 && ((inventory as any).leite_jersey ?? 0) >= 4 && ((inventory as any).sal ?? 0) >= 1, reqLevel: 15, onClick: (e: React.MouseEvent) => c.craftGoudaJersey(e) },
                  { label: 'Peixe Defumado', emoji: '🐟', req: `🐟 1 Tilápia (${(inventory as any).peixe ?? 0}/1) + 🧂 1 Sal (${(inventory as any).sal ?? 0}/1) • Nv12`, canCraft: farmLevel >= 12 && ((inventory as any).peixe ?? 0) >= 1 && ((inventory as any).sal ?? 0) >= 1, reqLevel: 12, onClick: (e: React.MouseEvent) => c.craftPeixeDefumado(e) },
                  { label: 'Bolinho de Peixe', emoji: '🥟', req: `🐟 1 Tilápia (${(inventory as any).peixe ?? 0}/1) + 🌾 1 Farinha (${(inventory as any).farinha ?? 0}/1) + 🥚 1 Ovo (${inventory.egg}/1) • Nv12`, canCraft: farmLevel >= 12 && ((inventory as any).peixe ?? 0) >= 1 && ((inventory as any).farinha ?? 0) >= 1 && (inventory.egg ?? 0) >= 1, reqLevel: 12, onClick: (e: React.MouseEvent) => c.craftBolinhoPeixe(e) },
                  { label: 'Moqueca da Fazenda', emoji: '🍲', req: `🐟 2 Tilápias (${(inventory as any).peixe ?? 0}/2) + 🥛 1 Leite (${inventory.milk}/1) + 🧂 1 Sal (${(inventory as any).sal ?? 0}/1) • Nv12`, canCraft: farmLevel >= 12 && ((inventory as any).peixe ?? 0) >= 2 && (inventory.milk ?? 0) >= 1 && ((inventory as any).sal ?? 0) >= 1, reqLevel: 12, onClick: (e: React.MouseEvent) => c.craftMoqueca(e) },
                  { label: 'Conserva de Peixe', emoji: '🐟', req: `🐟 2 Tilápias (${inventory.peixe ?? 0}/2) • Nv12`, canCraft: farmLevel >= 12 && (inventory.peixe ?? 0) >= 2, reqLevel: 12, onClick: (e: React.MouseEvent) => c.craftConservaPeixe(e) },
                  ...
                  { label: 'Massa Fresca de Ovo de Ganso', emoji: '🍝', req: `🪿 1 Ov.Ganso (${inventory.goose_egg ?? 0}/1) + 🌾 1 Farinha (${(inventory as any).farinha ?? 0}/1) • Nv13`, canCraft: farmLevel >= 13 && (inventory.goose_egg ?? 0) >= 1 && ((inventory as any).farinha ?? 0) >= 1, reqLevel: 13, onClick: (e: React.MouseEvent) => c.craftMassaFresca(e) },
            ...
            {atelieTab === 'luxo' && (
              <div className="space-y-2">
                ...
                {[
                  ...
                  { label: 'Bolsa Exótica', emoji: '👜', req: `🐊 1 Couro Jacaré (${inventory.couro_jacare ?? 0}/1) • Nv20`, canCraft: farmLevel >= 20 && (inventory.couro_jacare ?? 0) >= 1, reqLevel: 20, onClick: (e: React.MouseEvent) => c.craftBolsaExotica(e) },
